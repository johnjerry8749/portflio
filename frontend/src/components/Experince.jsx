          ...
          {items.map((item, index) => (
            <div key={index} className="col-12">
              <div className="row gx-0 align-items-center">
                <div className={`col-12 col-lg-5 d-flex ${item.side === "left" ? "justify-content-lg-end" : "justify-content-lg-start"}`}>
                  <div className="card shadow-sm border-0 rounded-3 p-4" style={{ maxWidth: "520px", width: "100%" }}>
                ...
                <div className="col-12 col-lg-2 d-flex justify-content-center position-relative">
                  <div className="d-none d-lg-flex flex-column align-items-center position-relative">
